...
- [Production website map](https://github.com/nicolas-found42/website-redesign/issues/9) (issue tracker): destination, settled direction, open decisions and scope. Supersedes the removed `SPEC-PLAN.md`.
